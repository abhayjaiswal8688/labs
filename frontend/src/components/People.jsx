...
export function People() {
    ...
    return (
        <body className="bg-white text-[#2e2e2e]">
            ...
            <section className="max-w-6xl mx-auto px-4 py-12">
                ...
                <div id="member-grid" className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6">
                    <div className="relative text-center bg-[#eeeeee] p-4 rounded-lg shadow-md transform transition hover:shadow-lg cursor-pointer hover-plus" onClick={() => openModal(0)}>
                        <img src={ members[0].image } alt="Rocky Barilla" className="h-[93%] object-cover rounded mb-2" />
                        <h4 className="font-semibold text-[#003865]">Rocky Barilla</h4>
                    </div>
                    <div className="relative text-center bg-[#eeeeee] p-4 rounded-lg shadow-md transform transition hover:shadow-lg cursor-pointer hover-plus" onClick={() => openModal(1)}>
                        <img src={ mem2 } alt="Michelle Bookstaver, PHD" className="h-[93%] object-cover rounded mb-2" />
                        <h4 className="font-semibold text-[#003865]">Michelle Bookstaver, PHD</h4>
                    </div>
                    <div className="relative text-center bg-[#eeeeee] p-4 rounded-lg shadow-md transform transition hover:shadow-lg cursor-pointer hover-plus" onClick={() => openModal(2)}>
                        <img src={ mem3 } alt="Hee Sun Choi, PHD" className="h-[93%] object-cover rounded mb-2" />
                        <h4 className="font-semibold text-[#003865]">Hee Sun Choi, PHD</h4>
                    </div>
                    <div className="relative text-center bg-[#eeeeee] p-4 rounded-lg shadow-md transform transition hover:shadow-lg cursor-pointer hover-plus" onClick={() => openModal(3)}>
                        <img src={ mem4 } alt="Joshua Choi, PHD" className="h-[93%] object-cover rounded mb-2" />
                        <h4 className="font-semibold text-[#003865]">Joshua Choi, PHD</h4>
                    </div>
                    <div className="relative text-center bg-[#eeeeee] p-4 rounded-lg shadow-md transform transition hover:shadow-lg cursor-pointer hover-plus" onClick={() => openModal(4)}>
                        <img src={ mem5 } alt="Xiaokai Ding, PHD" className="h-[93%] object-cover rounded mb-2" />
                        <h4 className="font-semibold text-[#003865]">Xiaokai Ding, PHD</h4>
                    </div>
                    <div className="relative text-center bg-[#eeeeee] p-4 rounded-lg shadow-md transform transition hover:shadow-lg cursor-pointer hover-plus" onClick={() => openModal(5)}>
                        <img src={ mem6 } alt="Karen Dixon, PHD" className="h-[93%] object-cover rounded mb-2" />
                        <h4 className="font-semibold text-[#003865]">Karen Dixon, PHD</h4>
                    </div>
                    <div className="relative text-center bg-[#eeeeee] p-4 rounded-lg shadow-md transform transition hover:shadow-lg cursor-pointer hover-plus" onClick={() => openModal(6)}>
                        <img src={ mem7 } alt="Ed Greenfield, PHD" className="h-[93%] object-cover rounded mb-2" />
                        <h4 className="font-semibold text-[#003865]">Ed Greenfield, PHD</h4>
                    </div>
                    <div className="relative text-center bg-[#eeeeee] p-4 rounded-lg shadow-md transform transition hover:shadow-lg cursor-pointer hover-plus" onClick={() => openModal(7)}>
                        <img src={ mem8 } alt="Mio Hamatani, MD, PHD" className="h-[93%] object-cover rounded mb-2" />
                        <h4 className="font-semibold text-[#003865]">Mio Hamatani, MD, PHD</h4>
                    </div>
                </div>
            </section>
            ...
            <section className="max-w-6xl mx-auto px-4 py-12">
                ...
                <ul id="alumni-list" className="list-disc pl-6 space-y-3 text-[#003865] hidden">
                    <li><strong>1989–1992:</strong><p className="text-black"> Edward Greenfield, PhD – Director, Antibody Core Facility, Dana-Farber Cancer Institute</p></li>
                    <li><strong>1992–1996:</strong><p className="text-black"> Mercy Prabhu Das, PhD – NIH/NIAID, Bethesda, MD</p></li>
                    <li><strong>1994–1997:</strong><p className="text-black"> Lindsay Nicholson, PhD – Associate Professor, Bristol University, UK</p></li>
                    <li><strong>1994–1997:</strong><p className="text-black"> Jeffery Encinas, PhD – Head of Molecular Biology, Nippon Boehringer Ingelheim</p></li>
                    <li><strong>1995–1998:</strong><p className="text-black"> Anwar Murtaza, PhD – Principal Scientist, Abbott Research Labs</p></li>
                    <li><strong>2016–2023:</strong><p className="text-black"> Alexandra Schnell, PhD – Postdoc, Whitehead Institute, Cambridge, MA</p></li>
                </ul>
            </section>
