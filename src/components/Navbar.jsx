...
export function Flyout_content({children,href,Flying_content}){
    ...
    onMouseLeave={()=>setDropdown(false)}
     className="relative relative h-fit w-fit">
        <div className="relative text-2xl hover:text-orange-600 cursor-pointer" onClick={()=>{href?Navigate(href):null}}>
        {children}
        <span
        style={{
...
export function Navbar(){
    const Navigate=useNavigate();
    return<div className="flex justify-end-safe justify-evenly mt-7 mb-5">
       <Flyout_content href="/" Flying_content={Null} >Kumar Lab</Flyout_content>
        <Flyout_content href="/people" Flying_content={Null}>People</Flyout_content>
        <Flyout_content href="/project" Flying_content={Null}>Project</Flyout_content>
        <Flyout_content href="/publications" Flying_content={Null}>Publication</Flyout_content>
