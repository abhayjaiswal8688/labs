...
export function Project(props){
  ...
  <div class="..."><div class="p-5 rounded-2xl shadow hover:shadow-lg transition-all duration-300 transform hover:bg-blue-50 hover:scale-102">
                ...
                <div class="p-5 flex justify-center"><h2 class="text-2xl font-semibold text-blue-900">TH17 CELLS AND INDUCTION OF TISSUE INFLAMMATION"</h2></div>
  ...
  <div class="...">
                ...
                <div class="p-5 flex justify-center items-center"><h2 class="text-2xl font-semibold text-blue-900">ROLE OF TIM-3 AND OTHER CO-INHIBITORY RECEPTORS IN T CELL EXHAUSTION AND T CELL INHIBITION</h2></div>
   ...
   <div class="...">
                ...
                <div class="p-5 flex justify-center items-center"><h2 class="text-2xl font-semibold text-blue-900">TIGIT</h2></div>
  ...
  <div class="...">
                ...
                <div class="p-5 flex justify-center items-center"><h2 class="text-2xl font-semibold text-blue-900">GENERATION OF TCR TRANSGENIC MICE FOR MYELIN ANTIGENS</h2></div>
